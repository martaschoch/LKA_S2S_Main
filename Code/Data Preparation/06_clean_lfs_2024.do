...
import delimited "$lfs/RAW/LFS-With Computer-2024-100%/LFS-With Computer-2024-100%/2024LFSAnnual-OutFile-With-Computer.csv" , clear 
...
destring sin tamil eng , replace 
...
destring cuedu age edu , replace
tab edu 
...
save "$data/cleaned/lfs2024_ind_clean", replace 
...
save "$data/lfs2024_clean", replace 
